...
export default function Cart() {
    ...
    return (
        <>
            ...
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded fixed  bottom-3 right-3" onClick={()=>Cookies.remove('cartData')}>
                Check Out
            </button>
